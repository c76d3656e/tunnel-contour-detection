...
@app.command()
def view(host: str = "127.0.0.1", port: int = 8765, open_browser: bool = True):
    """Serve the static 3D viewer. LAS files are opened in the browser."""
    from .server import run_server
    typer.echo(f"viewer http://{host}:{port}  (open a local .las in the page)")
